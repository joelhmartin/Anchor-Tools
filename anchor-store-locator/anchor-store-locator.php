...
class Module {
    ...
    public function __construct() {
        ...
        require_once __DIR__ . '/class-store-manager.php';
        $this->manager = new Store_Manager( $this );
    }
    ...
    public function render_metabox( $post ) {
        ...
        <div class="anchor-store-meta">
            ...
            <p>
                <label for="anchor_store_owner"><strong><?php echo \esc_html__( 'Owner', 'anchor-schema' ); ?></strong></label><br />
                <input type="text" id="anchor_store_owner" name="anchor_store_owner" value="<?php echo \esc_attr( $owner ); ?>" class="regular-text" />
            </p>
            <p>
    ...
    public function save_meta( $post_id ) {
        ...
        \update_post_meta( $post_id, '_anchor_store_owner', \sanitize_text_field( $_POST['anchor_store_owner'] ?? '' ) );
        ...
        <div class="anchor-store-locator-admin">
            ...
            <div class="anchor-store-panel">
                ...
                <form method="post" action="<?php echo \esc_url( \admin_url( 'admin-post.php' ) ); ?>" id="anchor-store-form" class="anchor-store-form">
                    ...
                    <p>
                        <label for="anchor-store-owner"><strong><?php echo \esc_html__( 'Owner', 'anchor-schema' ); ?></strong></label><br />
                        <input type="text" id="anchor-store-owner" name="anchor_store_owner" class="regular-text" />
                    </p>
                    <p>
    ...
    public function ajax_place_search() {
        ...
        // Also reachable from the front-end store manager, which runs at a
        // lower capability than the admin settings tab.
        if ( ! \current_user_can( 'manage_options' ) && ! $this->manager->can_manage() ) {
    ...
    public function handle_store_creation() {
        ...
        $owner = isset( $_POST['anchor_store_owner'] ) ? \sanitize_text_field( \wp_unslash( $_POST['anchor_store_owner'] ) ) : '';
        ...
        \update_post_meta( $post_id, '_anchor_store_phone', $phone );
        \update_post_meta( $post_id, '_anchor_store_maps_url', $maps_url );
        \update_post_meta( $post_id, '_anchor_store_owner', $owner );
